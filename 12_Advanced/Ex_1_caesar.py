...
# Some problems that need solving - what to do if number runs off the end of the alphabet;
# What to do with caps/lower case letters
# What to do if with punctuation and spaces

# Maybe ignore spaces and punctuation and keep as is.
# Maybe run straight through from the lower to the upper case letters rather that dealing with both
